...
def test_channels_event_init(channels_init, channels_mock):
    ...
    assert event.details.fig_path == channels_mock["keyboard"]["details"].fig_path
...
def test_channels_keyboard_init(channels_init, channels_mock):
    ...
    assert keyboard.details.fig_path == channels_mock["keyboard"]["details"].fig_path
    assert (
...
def test_channels_waveform_init(channels_init, channels_mock):
    ...
    assert waveform.details.fig_path == channels_mock["waveform"]["details"].fig_path
    assert (
...
def test_channels_wavemark_init(channels_init, channels_mock):
    ...
    assert wavemark.details.fig_path == channels_mock["wavemark"]["details"].fig_path
    assert (
